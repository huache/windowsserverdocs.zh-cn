...
> [!NOTE]
> Microsoft.ClassicCompute VM 要求对扩展安全更新部署进行额外的配置，原因是它们无权访问 [Azure 实例元数据服务](/azure/virtual-machines/windows/instance-metadata-service)，而该服务决定了扩展安全更新的资格。 请联系 [Microsoft 支持部门](https://support.microsoft.com/contactus?PID=17336)获取更多帮助。
