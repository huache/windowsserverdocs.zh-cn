---
title: 子命令集-映像
description: 子命令集的 Windows 命令主题，它更改映像的属性。
...
使用 "" 命令的 "
[导出映像"](using-the-export-image-command.md)命令，
使用 "[替换映像](using-the-replace-image-command.md)" 命令
使用 "[删除](using-the-remove-image-command.md)图像" 命令[Using the get-Image Command](using-the-get-image-command.md)
