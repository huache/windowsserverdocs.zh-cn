---
title: 子命令集-映像
description: 子命令集-Image 的参考主题，用于更改映像的属性。
...
使用 "复制[-映像"](using-the-add-image-command.md)命令通过 "复制映像" 命令使用 "[复制映像](using-the-copy-image-command.md)
...
" 命令通过使用 "[替换图像](using-the-replace-image-command.md)" 命令使用 "[删除图像](using-the-remove-image-command.md)
" 命令
