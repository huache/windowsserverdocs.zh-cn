...
可以通过使用组策略在 "**计算机配置**" &gt;**管理模板** **&gt; &gt;** **远程桌面服务 &gt;** 远程桌面会话主机 **&gt; &gt;** **远程会话环境** **下的 "** 远程桌面协议 可能有三个值：
...
通过使用 "**计算机配置**&gt;**管理模板**&gt; **Windows 组件**" 中的 "组策略"，可以配置设备重**定向 &gt; 远程桌面服务 &gt; 远程桌面会话主机** **设备和资源重定向，** 或**使用 &gt; 中**的 "**会话集合**属性" 框。
