...
Arpa 域适用于基于 Internet 协议版本4（IPv4）寻址的所有 TCP/IP 网络。 新建区域向导会自动假定您在创建新的反向查找区域时使用此域。
...
##### <a name="create-a-user-account-in-active-directory-users-and-computers"></a><a name="BKMK_createUA"></a>在 Active Directory 用户和计算机中创建用户帐户
...
##### <a name="install-dynamic-host-configuration-protocol-dhcp"></a><a name="BKMK_installDHCP"></a>安装动态主机配置协议（DHCP）
...
###### <a name="to-install-nps"></a>安装 NPS
...
-   [动态主机配置协议（DHCP）概述](https://technet.microsoft.com/library/hh831825.aspx)https://technet.microsoft.com/library/hh831825.aspx。
...
## <a name="appendix-e---core-network-planning-preparation-sheet"></a><a name="BKMK_E"></a>附录 E-核心网络规划准备工作表
...
#### <a name="creating-a-new-dhcp-scope"></a><a name="bkmk_NetFndtn_Pln_DHCP_NewScope"></a>创建新的 DHCP 作用域
