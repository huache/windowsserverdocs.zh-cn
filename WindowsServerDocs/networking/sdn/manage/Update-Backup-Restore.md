...
有关可能出现的配置状态消息的信息，请参阅[排查 Windows Server 2016 软件定义的网络堆栈问题](../troubleshoot/troubleshoot-windows-server-software-defined-networking-stack.md)。