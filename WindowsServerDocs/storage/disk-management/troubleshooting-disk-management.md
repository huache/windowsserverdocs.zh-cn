...
8. 把磁盘插到另一台电脑上。
    ...
    如果磁盘不能在另一台电脑上工作，这是一个好迹象，说明磁盘出了问题，而不是电脑出了问题。 我们知道毫无乐趣可言。 在 [Microsoft 社区](https://answers.microsoft.com/)站点上进行搜索或寻求帮助，或联系你的磁盘制造商或 [Microsoft 支持部门](https://support.microsoft.com/contactus/)。
