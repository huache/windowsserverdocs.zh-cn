...
2.  [下载 Microsoft Azure 多重身份验证服务器](../../ad-fs/operations/Walkthrough-Guide--Manage-Risk-with-Additional-Multi-Factor-Authentication-for-Sensitive-Applications.md#BKMK_b)

3.  [在联合服务器上安装 Microsoft Azure 多重身份验证服务器](../../ad-fs/operations/Walkthrough-Guide--Manage-Risk-with-Additional-Multi-Factor-Authentication-for-Sensitive-Applications.md#BKMK_c)
...
6.  填写以下字段并选择“创建”。
    ...
    2.  **使用模型**-多重身份验证提供程序的使用模型。
        ...
        -   **按**身份验证-购买按身份验证收费的模型。 在面向消费者的应用程序中使用 Windows Azure Multi-Factor Authentication 的方案通常使用该选项。
