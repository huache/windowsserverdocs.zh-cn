...
9. 根据组织的需要，选择下列选项之一：
    ...
    -   **仅传递以特定值** 
 ![ 开头的声明值创建规则](media/Create-a-Rule-to-Send-an-AD-FS-1x-Compatible-Claim/adfs3.PNG)
...
9. 根据组织的需要，选择下列选项之一：
    ...
    -   **仅传递以特定值** 
 ![ 开头的声明值创建规则](media/Create-a-Rule-to-Send-an-AD-FS-1x-Compatible-Claim/adfs1.PNG)
