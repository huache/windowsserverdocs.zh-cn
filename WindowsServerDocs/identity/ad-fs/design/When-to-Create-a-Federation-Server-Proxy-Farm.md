...
ms.locfileid: "87945127"
---
# <a name="when-to-create-a-federation-server-proxy-farm"></a>何时创建联合服务器代理场

当你具有大型 Active Directory 联合身份验证服务 \( AD FS \) 部署，并且想要为代理部署提供容错、负载 \- 平衡和可伸缩性时，请考虑安装其他联合服务器代理。 在同一外围网络中创建两个或多个联合服务器代理，并配置每个代理以保护相同的 AD FS 联合身份验证服务创建联合服务器代理场。
...
必须先在一个 IP 地址和一个域名系统 \( DNS \) 完全限定的域名 FQDN 下对所有联合服务器代理进行群集，然后才能将所有联合服务器代理作为场一起工作 \( \) 。 可以通过在 \( 外围网络内部署 Microsoft 网络负载平衡 NLB 来对服务器进行群集 \) 。 下表中的任务需要适当地配置 NLB，以便群集到场中的联合服务器代理。
