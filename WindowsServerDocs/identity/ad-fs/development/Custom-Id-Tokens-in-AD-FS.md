...
3. 将作用`allatclaims`域分配到客户端– RP 配对。

可以按照以下示例中所示， `Grant-ADFSApplicationPermission`使用 cmdlet 来分配作用域：
...
4. 对于 "**重定向 URI** - **https://localhost:44320/**"，请输入以下内容：。  单击“添加”  。 单击“下一步”。 
