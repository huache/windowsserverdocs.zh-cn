...
* [使用 SQL Server 复制设置地理冗余](deployment/Set-up-Geographic-Redundancy-with-SQL-Server-Replication.md)
...
* [Azure 中使用 Azure 流量管理器的 AD FS](deployment/active-directory-adfs-in-azure-with-azure-traffic-manager.md)
