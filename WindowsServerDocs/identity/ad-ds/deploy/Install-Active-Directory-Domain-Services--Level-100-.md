...
|                                                                                                             LogPath <string>                                                                                                             |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            指定指向本地计算机（包含域日志文件）固定磁盘上目录的完全限定的非 UNC 路径，例如，**C:\Windows\Logs**。<p>默认值为 **%SYSTEMROOT%\NTDS**。 **重要提示：** 不要将 Active Directory 日志文件存储在使用复原文件系统格式化的数据卷上 (ReFS) 。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
