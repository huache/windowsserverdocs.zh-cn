...
|17|将关键资产迁移到具有严格的安全和监视要求的处于纯洁林。|战略|两者都是|  
|18|简化最终用户的安全性。|战略|预防|  
|19|使用基于主机的防火墙来控制和保护通信。|战术|预防|  
|20|修补设备。|战术|预防|  
|21|为 IT 资产实现以业务为中心的生命周期管理。|战略|N/A|  
|22|创建或更新事件恢复计划。|战略|N/A|  
