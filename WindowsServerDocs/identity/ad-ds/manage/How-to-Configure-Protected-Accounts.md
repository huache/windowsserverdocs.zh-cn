...
## <a name="BKMK_AddtoProtectedUsers"></a>受保护用户
...
### <a name="BKMK_Prereq"></a>使用受保护帐户的要求
受保护帐户具有以下部署要求：
...
### <a name="BKMK_TrubleshootingEvents"></a>排查与受保护用户相关的事件
...
### <a name="BKMK_ProvidePUdcProtections"></a>为服务和计算机提供 DC 端保护
...
### <a name="BKMK_TroubleshootAuthnPolicies"></a>排查身份验证策略问题
