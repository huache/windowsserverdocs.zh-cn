...
|**方案：拒绝访问协助**<br /><br />现在，当用户尝试访问文件服务器上的远程文件时，能得到的仅有指示是访问被拒绝。 这将生成支持人员或 IT 管理员请求，它们需要弄清问题是什么，而管理员通常很难从用户那里得到合适的上下文，这使得解决问题更困难了。 <br />在 Windows Server 2012 中，我们的目标是尝试帮助信息工作者和业务所有者来处理访问被拒问题，并在涉及到该问题时，提供所有正确的信息以快速解决问题。 实现这一目标的挑战之一是，无法集中处理访问被拒，每个应用程序以不同的方式处理它，因此在 Windows Server 2012 中，其中一项目标是改进 Windows 资源管理器的访问被拒体验。|[方案：拒绝访问协助](Scenario--Access-Denied-Assistance.md)|[规划 "拒绝访问" 协助](assetId:///b169f0a4-8b97-4da8-ae4a-c8f1986d19e1)<br /><br />-   [确定 "拒绝访问" 协助模式](assetId:///b169f0a4-8b97-4da8-ae4a-c8f1986d19e1#BKMK_1.1)<br />-   [确定哪些用户应处理访问请求](assetId:///b169f0a4-8b97-4da8-ae4a-c8f1986d19e1#BKMK_12)<br />-   [自定义拒绝访问协助消息](assetId:///b169f0a4-8b97-4da8-ae4a-c8f1986d19e1#BKMK_13)<br />-   [异常计划](assetId:///b169f0a4-8b97-4da8-ae4a-c8f1986d19e1#BKMK_1.4)<br />-   [确定如何部署 "拒绝访问" 协助](assetId:///b169f0a4-8b97-4da8-ae4a-c8f1986d19e1#BKMK_1.5)|[部署拒绝访问协助&#40;演示步骤&#41;](Deploy-Access-Denied-Assistance--Demonstration-Steps-.md)||  
