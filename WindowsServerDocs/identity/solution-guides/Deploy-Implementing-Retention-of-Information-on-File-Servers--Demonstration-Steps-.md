...
## <a name="step-2-configure-notifications"></a><a name="BKMK_Step2"></a>步骤 2：配置通知
...
## <a name="step-3-create-a-file-management-task"></a><a name="BKMK_Step3"></a>步骤 3：创建文件管理任务
...
## <a name="step-4-classify-a-file-manually"></a><a name="BKMK_Step4"></a>步骤 4：手动分类文件
...
-   [文件服务器信息保留方案](assetId:///edf13190-7077-455a-ac01-f534064a9e0c)
