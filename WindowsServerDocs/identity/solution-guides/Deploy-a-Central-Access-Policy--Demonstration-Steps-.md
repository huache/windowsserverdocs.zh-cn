...
## <a name="plan-identify-the-need-for-policy-and-the-configuration-required-for-deployment"></a><a name="BKMK_1.2"></a>计划：确定需要策略和部署所需的配置
...
## <a name="implement-configure-the-components-and-policy"></a><a name="BKMK_1.3"></a>实现：配置组件和策略
...
4. 在“目标资源”**** 部分中，单击“编辑”****，然后在 **“中心访问规则”** 对话框中，单击“添加一个条件”****。 添加以下条件： [**资源**] [**部门**] [**等于**] [**值**] [**财务**]，然后单击 **"确定"**。
...
7. 在 "**权限的权限条目**" 对话框中，单击 "**添加条件**"，并添加以下条件： [**用户**] [**国家/地区**] [**任何**] [**资源**] [**country**] 单击 "**添加条件**"。
    [**和**]依次单击[“用户”****]、[“部门”****]、[“任何”****]、[“资源”****]和[“部门”****]。 将“权限”**** 设置为“读取”****。
...
6. 单击 "**添加条件**" 链接，然后添加以下条件： [**用户**] [**国家/地区**] [**任何**] [**资源**] [**country**]。
