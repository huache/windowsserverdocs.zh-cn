...
## <a name="BKMK_3"></a>步骤3：使用文件管理任务通过 AD RMS 自动保护文档  
...
## <a name="BKMK_5"></a>步骤5：验证 AD RMS 的保护  
