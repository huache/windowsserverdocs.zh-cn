...
## [在 Windows 中禁用按用户服务](/windows/application-management/per-user-services-in-windows)
...
### [使用远程 Credential Guard 来保护远程桌面凭据](/windows/security/identity-protection/remote-credential-guard)
