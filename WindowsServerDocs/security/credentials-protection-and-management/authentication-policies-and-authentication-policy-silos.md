...
有关配置身份验证策略接收器和身份验证策略的信息，请参阅[如何配置受保护的帐户](../../identity/ad-ds/manage/how-to-configure-protected-accounts.md)。
...
通过使用 Active Directory 管理控制台或 Windows PowerShell，可以配置身份验证策略接收器。 有关详细信息，请参阅[如何配置受保护的帐户](../../identity/ad-ds/manage/how-to-configure-protected-accounts.md)。
...
通过使用 Active Directory 管理控制台或 Windows PowerShell，可以为每个接收器配置身份验证策略。 有关详细信息，请参阅[如何配置受保护的帐户](../../identity/ad-ds/manage/how-to-configure-protected-accounts.md)。
...
-   [Kerberos 版本 5 身份验证协议的工作原理](/previous-versions/windows/it-pro/windows-server-2003/cc772815(v=ws.10))

-   [Kerberos 身份验证中的更改](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/dd560670(v=ws.10))（Windows Server 2008 R2 和 Windows 7）
