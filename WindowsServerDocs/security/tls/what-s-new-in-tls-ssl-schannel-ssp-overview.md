...
### <a name="management-of-trusted-issuers-for-client-authentication"></a><a name="BKMK_TrustedIssuers"></a>管理用于客户端身份验证的受信任颁发者
...
### <a name="deprecated-functionality"></a><a name="BKMK_Deprecated"></a>弃用的功能
