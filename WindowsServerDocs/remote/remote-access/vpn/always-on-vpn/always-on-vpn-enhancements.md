...
|**[Windows Hello 企业版](/windows/access-protection/hello-for-business/hello-overview)** |Always On VPN 本机支持 Windows Hello 企业版（在基于证书的身份验证模式下），以便为登录到计算机和连接到 VPN 提供无缝单一登录体验。 因此，VPN 连接不需要辅助身份验证（用户凭据），因此可以将 Always On 连接与 Windows Hello 企业版身份验证配合使用。 |
