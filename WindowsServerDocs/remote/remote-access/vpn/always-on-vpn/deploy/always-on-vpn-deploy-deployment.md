...
在此步骤中，你将通过使用 Windows PowerShell 或服务器管理器添加角色和功能向导 (NPS) 安装网络策略服务器。 你还可以将 NPS 配置为处理从 VPN 服务器接收的连接请求的所有身份验证、授权和记帐职责。
...
## <a name="step-7-optional-configure-conditional-access-for-vpn-connectivity"></a>[步骤7。 (可选) 为 VPN 连接配置条件访问](../../ad-ca-vpn-connectivity-windows10.md)
