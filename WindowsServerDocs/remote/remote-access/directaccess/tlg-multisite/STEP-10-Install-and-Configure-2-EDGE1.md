...
14. 在 "证书" 管理单元的详细信息窗格中，验证名为 "2-edge1.contoso.com" 的新证书是否已注册到服务器身份验证的预期目的，并使用 "客户端身份验证" 和 "服务器身份验证" 的预期目的注册了名称为 "2-edge1.corp2.corp.contoso.com" 的新证书。
