...
1.  在 CLIENT1 上，单击 "**开始**"，键入**powershell.exe**，右键单击 " **Powershell**"，单击 "**高级**"，然后单击 "以**管理员身份运行**"。 如果出现了“用户帐户控制”**** 对话框，请确认其所显示的操作是你要采取的操作，然后单击“是”****。
...
12. 在 Internet Explorer 地址栏中，输入 **https://2-app1/** 并按 enter。 你将在 APP1 上看到默认网站。

13. 在 Internet Explorer 地址栏中，输入 **https://app2/** 并按 enter。 在 APP2 上，你将看到默认网站。
...
19. 在控制台的左窗格中，展开 "**安全关联**" 节点，然后单击 "**主模式**" 节点。 请注意，基础结构使用 NTLMv2 和 intranet 隧道安全关联（使用 Kerberos V5）建立隧道安全关联。 右键单击显示**User (Kerberos V5) **为**第二身份验证方法**的条目，然后单击 "**属性**"。 在 "**常规**" 选项卡上，请注意**第二个 "身份验证本地 ID** " 为**CORP\User1**，表示 User1 能够使用 Kerberos 成功地向公司域进行身份验证。
...
10. 在 Internet Explorer 地址栏中，输入 **https://2-app1/** 并按 enter。 在 APP2 上，你将看到默认网站。

11. 在 Internet Explorer 地址栏中，输入 **https://app2/** 并按 enter。 你将在 APP3 上看到默认网站。
