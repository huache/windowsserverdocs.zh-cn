...
5.  在****“身份验证”页上：
    ...
    -   在****“用户身份验证”中单击****“Active Directory 凭据”。 若要使用双重身份验证配置部署，请单击****“双重身份验证”。 有关详细信息，请参阅[使用 OTP 身份验证部署远程访问](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/hh831379(v=ws.11))。
...
若要为所有计算机启用远程访问 (仅) 的笔记本和便携式计算机，以及为 Windows 7 客户端启用远程访问：
