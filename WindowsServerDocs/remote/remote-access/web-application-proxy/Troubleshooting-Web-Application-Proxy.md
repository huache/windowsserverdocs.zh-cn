...
|12003<br /><br />Web 应用程序代理无法分析访问 cookie。|这可能表示 Web 应用程序代理和 AD FS 未连接，或者它们不接收相同的配置。|检查与 AD FS 的连接。 您可以使用 link https：//< FQDN_AD_FS_Proxy >/FederationMetadata/2007-06/FederationMetadata.xmlMake 来完成此操作。请确保 AD FS 和 Web 应用程序代理之间建立了信任关系。 如果这些解决方案不起作用，请运行 Install-webapplicationproxy Cmdlet。|  
