...
ms.locfileid: "87948353"
---
# <a name="windows-81-should-be-configured-with-the-recommended-amount-of-memory"></a>应使用建议的内存量配置 Windows 8。1
...
## <a name="issue"></a>**问题**
*运行 Windows 8.1 的虚拟机配置为小于建议的 RAM 量，即 1 GB。*
