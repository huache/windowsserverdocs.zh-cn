---
title: 至少为运行 Windows Server 2008 并为动态内存启用的虚拟机配置所需的内存量
...
ms.locfileid: "71365008"
---
# <a name="configure-at-least-the-required-amount-of-memory-for-a-virtual-machine-running-windows-server-2008-and-enabled-for-dynamic-memory"></a>至少为运行 Windows Server 2008 并为动态内存启用的虚拟机配置所需的内存量
...
## <a name="issue"></a>问题  
*一台或多台虚拟机配置为使用小于 Windows Server 2008 所需的内存量的动态内存。*  
