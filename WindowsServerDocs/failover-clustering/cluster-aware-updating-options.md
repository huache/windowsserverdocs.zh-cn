...
description: '如何为群集感知更新配置高级选项和更新运行配置文件 (CAU) '
ms.topic: article
manager: lizross
ms.author: jgerend
author: JasonGerend
...
ms.locfileid: "87990895"
---
# <a name="cluster-aware-updating-advanced-options-and-updating-run-profiles"></a>群集感知更新高级选项和更新运行配置文件

> 适用于： Windows Server 2019，Windows Server 2016，Windows Server 2012 R2，Windows Server 2012。

本主题介绍了如何更新运行选项，这些选项可用于配置[群集感知更新](cluster-aware-updating.md) (CAU) 更新运行。 当使用 CAU UI 或 CAU Windows PowerShell cmdlet 来应用更新或者配置自我更新选项时，可以配置这些高级选项。
...
|选项|默认值|详细信息|
|------------|-------------------|-------------|
|**ClusterName**|None <br>**注意：** 仅当 CAU UI 未在故障转移群集节点上运行，或者要引用不同于 CAU UI 运行位置的故障转移群集时，才必须设置此选项。|要在其上执行更新运行的群集的 NetBIOS 名称。|
|**凭据**|当前帐户凭据|将执行更新运行的目标群集的管理凭据。 如果从对群集具有管理员权限的帐户) 使用 CAU PowerShell cmdlet，则你可能已具有所需的凭据 (或打开 PowerShell 会话。|
...
-   [Windows PowerShell 中的群集感知更新 Cmdlet](/powershell/module/clusterawareupdating/?view=win10-ps)