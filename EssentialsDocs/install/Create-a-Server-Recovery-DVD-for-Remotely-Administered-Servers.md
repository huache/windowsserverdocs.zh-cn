...
1. 向导页面提供了获取更多帮助的链接。 如果此 .chm 文件存在，则会覆盖 Web 帮助的 FWLink。 帮助文件位于：  
    ...
    < DVD 根\>\\$OEM $ \Customization\\< 区域性名称\>\RestartHelp.chm  
...
2. 该文件包含客户在向导页面看到的文本。 文本应该说明如何以恢复模式启动服务器。 控件是可滚动的，这就为可添加的文本量设置了实际的限制。  
    ...
    < DVD 根\>\\$OEM $ \Customization\\< 区域性名称\>\RestartInstructions.rtf  
  
3. < DVD 根\>\\$OEM $ \Customization\\< 区域性名称\>\ServerImage.png  
...
6. 将两个区域性文件夹从语言包复制\\< CultureName\>\Server 恢复到服务器恢复 DVD 的根目录。 例如：ES 和 ES-ES 文件夹都要复制到 DVD 的根目录以支持西班牙语。  
...
|-|-|  
|-cs-CZ<br /><br /> -反 de<br /><br /> -en-us<br /><br /> -es<br /><br /> -fr<br /><br /> -hu-HU<br /><br /> -it-IT<br /><br /> -ja-jp<br /><br /> -ko-KR<br /><br /> -nl-NL |-pl<br /><br /> -pt-BR<br /><br /> -pt-PT<br /><br /> -ru-RU<br /><br /> -sv-SE<br /><br /> -tr-TR<br /><br /> -zh-chs-CN<br /><br /> -zh-chs-HK<br /><br /> -zh-chs
