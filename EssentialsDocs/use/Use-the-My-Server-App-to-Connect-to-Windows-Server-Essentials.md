...
|使用 SharePoint Online 库| (Server 2012 R2 仅) 使用团队的 SharePoint Online 库中的文件。 打开团队网站。 （SharePoint Online 部分：打开团队网站，然后深化到要打开的文档库或文件。 打开文件时，你必须使用与你的网络帐户关联的 Microsoft 联机帐户登录到 Microsoft 365。 ) <br /><br /> **注意：** 若要使用此功能，服务器必须与 Microsoft 365 集成，Microsoft 365 订阅必须包括 SharePoint Online，并且服务器上的用户帐户必须具有与之关联的 Microsoft Online Services 帐户。 有关将 Microsoft 365 和 SharePoint Online 与 Windows Server Essentials 集成的信息，请参阅 [Windows Server essentials 的服务集成概述-第1部分](/archive/blogs/sbs/services-integration-overview-for-windows-server-2012-r2-essentials-part-1) 和 [windows Server Essentials 的服务集成概述-第2部分](/archive/blogs/sbs/services-integration-overview-for-windows-server-2012-r2-essentials-part-2)。|
